<x-utama >
     ...
     <section class="bg-white shadow-md rounded-md py-8 antialiased dark:bg-gray-900 md:py-16">
  <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    <div class="mx-auto max-w-5xl">
       <div class="flex w-full h-34 -mt-10 ml-12 mb-10">
           
   
<svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-16 h-16 text-blue-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" d="M3 8h18M3 12h12m-9 4h3m-6 4h18a2 2 0 002-2V6a2 2 0 00-2-2H3a2 2 0 00-2 2v12a2 2 0 002 2z"/>
      ...
      <h1 class="text-5xl font-semibold text-gray-800 ml-2 mt-3">Payment</h1>
    </div>
