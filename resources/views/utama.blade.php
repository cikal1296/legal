<x-app-layout><div class="antialiased bg-gray-50 dark:bg-gray-900">
      ...
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="https://flowbite.com" class="flex items-center justify-between mr-8">
            <span class="self-center text-2xl text-white font-semibold whitespace-nowrap dark:text-white "><span class="text-green-500">L</span>EGAL</span>
            <img
              ...
              class="mr-3 ml-3 h-8 rounded-sm"
              alt="Flowbite Logo"
            />
          </a>
          <form action="#" method="GET" class="hidden md:block md:pl-2">
            ...
            <div class="relative md:w-64 md:w-96">
              ...
              <input
                ...
                name="email"
                id="topbar-search"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Search"
              />
            </div>
          </form>
    ...
    <aside
      class="fixed top-32 pb-12 border-gray-100 left-0 z-40 w-18 rounded-2xl max-h-[calc(100vh-4rem)]  transition-transform -translate-x-full bg-white border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
      aria-label="Sidenav"
      ...
      <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        <form action="#" method="GET" class="md:hidden mb-2">
          ...
          <div class="relative">
            ...
            <ul
          class="  space-y-2 border-gray-200 dark:border-gray-700"
        >
          <li>
            <a
              href="/oper"
  ...
  >
    ...
    >
      <path fill-rule="evenodd"
        d="M10 2a4 4 0 0 0-4 4 4 4 0 0 0 8 0 4 4 0 0 0-4-4zm-6 14a6 6 0 0 1 12 0v1H4v-1z"
        clip-rule="evenodd"
      />
    </svg>
  ...
  >
    ...
    <main class="p-4  -ml-64 -mt-10 md:ml-64 h-auto pt-20">
      {{ $slot }}
    </main>
 </div></x-app-layout>