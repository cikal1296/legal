...
@viteReactRefresh
@vite([
    'resources/css/app.css',    // file lama: AOS, Alpine, Calendar
    'resources/js/app.js',    // file lama: AOS, Alpine, Calendar
    'resources/js/main.jsx',  // file React
])
